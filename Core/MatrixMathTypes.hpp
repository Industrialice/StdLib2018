...
namespace StdLib
{
    ...
    template <typename Basis> struct _Vector : Basis
    {
        ...
        bool IsNormalized(f32 epsilon = DefaultF32Epsilon) const;

        bool EqualsWithEpsilon(const _Vector &other, f32 epsilon = DefaultF32Epsilon) const;
    ...
    template <uiw Rows, uiw Columns> struct _Matrix
    {
        ...
        std::array<f32, Columns> &operator [] (uiw index);
        const std::array<f32, Columns> &operator [] (uiw index) const;
        ...
        bool EqualsWithEpsilon(const _Matrix &other, f32 epsilon = DefaultF32Epsilon) const;
    ...
    struct Quaternion
    {
        ...
        bool EqualsWithEpsilon(const Quaternion &other, f32 epsilon = DefaultF32Epsilon) const;
    };
